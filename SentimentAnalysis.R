...
#ROC Analysis
library(ROSE)
accuracy.meas(y_pred, test_set[,692])
#F=F1 score: Tradeoff between Precision and Recall
#precision: 0.405
#recall: 1
#F: 0.288
#Area under the curve = 67.5%
roc.curve(test_set[,692], y_pred, plotit=T) 

#freq table:
library(questionr)
freq_tab <- freq(dataset[,692])
freq_tab #Balanced dataset! 
...
#ROC Analysis: Logistic Regression
accuracy.meas(y_pred_2, test_set[,692])
#F=F1 score: Tradeoff between Precision and Recall
#precision: 0.560
#recall: 1
#F: 0.359
#Area under the curve = 55%
roc.curve(test_set[,692], y_pred_2, plotit=T) 
